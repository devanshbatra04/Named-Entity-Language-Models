###############################################################################
# Import dependencies, AWD LSTM as a Python Module
###############################################################################
...
PATH_TO_TYPE_NAMES = "./data_with_type/available_types.csv"
EVAL_BATCH_SIZE = 10
TEST_BATCH_SIZE = 1
BATCH_SIZE = 80
EMBEDDING_SIZE = 400
...
if __name__ == "__main__":
    corpus_with_types, corpus_without_types = load_datasets(DATA_WITHOUT_TYPES, PATH_TO_TYPE_NAMES)
    ...
    type_model, type_model_criterion, type_model_params = get_model(train_data_without_types)